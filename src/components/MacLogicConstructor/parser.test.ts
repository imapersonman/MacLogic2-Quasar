...
describe('parse', () => {
    ...
    const test_quantifier = (aq: string, q: string) => {
        ...
        test(`(${q}x)Fx`, () => expect(parse(`(${q}x)Fx`)).toEqual([aq, 'x', ['F', 'x']]))
        ...
        test(`(${q}x)(${q}y)(${q}z)Fxyz`, () => expect(parse(`(${q}x)(${q}y)(${q}z)Fxyz`)).toEqual([aq, 'x', [aq, 'y', [aq, 'z', ['F', 'x', 'y', 'z']]]]))
...
describe('unparse', () => {
    ...
    const test_quantifier = (aq: string) => {
        test(`['${aq}', 'x', ['F', 'x']]`, () => expect(unparse([aq, 'x', ['F', 'x']])).toEqual(`(${aq}x)Fx`))
        test(`['${aq}', 'x', ['${aq}', 'y', ['${aq}', 'z', ['F', 'x', 'y', 'z']]]]`, () => expect(unparse([aq, 'x', [aq, 'y', [aq, 'z', ['F', 'x', 'y', 'z']]]])).toEqual(`(${aq}x)(${aq}y)(${aq}z)Fxyz`))
